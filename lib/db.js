...
// NOTE: do NOT destructure window.supabase at module top-level — if the
// supabase script hasn't loaded yet the bundle throws and the app hangs.

const SUPABASE_URL = 'https://zxlvxfquzdzfukuosyky.supabase.co'
...
export const Transfers = {
  async getAll() {
    const { data, error } = await getClient()
      ...
      .select('*, job:jobs(work_order,model,serial)')
